...
int main()
{
    ...
    int status = setitimer(ITIMER_PROF, &new, NULL);

    while (1)
    {
        signal(SIGPROF, my_sig);
    }
}

/*
============================================================================
akash@akash-Inspiron-16-5630:~/Hands On List/Hands On List 2$ cc 1c.c -o 1c
akash@akash-Inspiron-16-5630:~/Hands On List/Hands On List 2$ ./1c
Timer Expired
Timer Expired
Timer Expired
============================================================================
